...
public class Tester {
    public static void main(String[] args) {
        JdkProxyHandler proxyInstance = new JdkProxyHandler(new Target());
...
//        System.out.println(c1[0]);
        ...
        CglibInterceptor<Target> cglibInterceptor = new CglibInterceptor(new Target());
        cglibInterceptor.getProxyTarget().methodA();
